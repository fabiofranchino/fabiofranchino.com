    ...
    head () {
        ...
        return {
            ...
            meta: [
                ...
                { hid:'ogurl', property: 'og:url', content: `https://www.fabiofranchino.com/automation/${this.page.slug}/` },
                { hid:'twurl', name: 'twitter:url', content: `https://www.fabiofranchino.com/automation/${this.page.slug}/` }
            ]
        }
    }
}
