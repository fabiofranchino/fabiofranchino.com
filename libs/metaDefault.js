module.exports = [
  ...
  { hid: 'ogurl', property: 'og:url', content: 'https://www.fabiofranchino.com/' },
  { hid: 'ogimg', property: 'og:image', content: 'https://www.fabiofranchino.com/social.png' },
  ...
  { hid: 'twurl', name: 'twitter:url', content: 'https://www.fabiofranchino.com/' },
  { hid: 'twimg', name: 'twitter:image', content: 'https://www.fabiofranchino.com/social.png' },

  { hid: 'description', name: 'description', content: 'Senior Designer / Technologist' },
  { hid: 'keywords', name: 'keywords', content: 'senior, designer, technologist' },
